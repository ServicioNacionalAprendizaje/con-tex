            ...
            try{
                ...
                while($rowCarpeta = $carpeta->conn->obtenerObjeto()){                  
                    $retorno .= "<div class='btn-group'>
                            <button type='button' class='btn btn btn-outline-dark dropdown-toggle' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>".$rowCarpeta->modulo."</button>
